...
class Experiment(Base):
    ...
    retriever_mode: Mapped[RetrieverMode] = mapped_column(
        Enum(RetrieverMode, name="retriever_mode"),
        nullable=False,
    )
    ...
    is_published: Mapped[bool] = mapped_column(
        Boolean, nullable=False, default=False, comment="Pinned to public leaderboard"
    )
...
class QueryResult(Base):
    ...
    __table_args__ = (Index("ix_qr_experiment_index", "experiment_id", "query_index"),)
