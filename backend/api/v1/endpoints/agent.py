...
class AgentQuerySchema(BaseModel):
    query_text: str = Field(
        ..., min_length=3, max_length=2048, description="Natural language query"
    )
        ...
        "nodes": [
            {
                "name": "QueryAnalyzer",
                "status": "ready",
                "description": "Query expansion + type classification",
            },
            {
                "name": "MultiRetriever",
                "status": "ready",
                "description": "Sparse + dense + hybrid retrieval",
            },
            {
                "name": "RankForge",
                "status": "ready",
                "description": "Cross-encoder reranking + MMR diversity",
            },
            {
                "name": "Synthesizer",
                "status": "ready",
                "description": "LLM answer synthesis with grounding",
            },
            {
                "name": "OutputFormatter",
                "status": "ready",
                "description": "Citation formatting + confidence scoring",
            },
        ],
