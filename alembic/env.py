# =============================================================================
# RetrievalLab — alembic/env.py
# =============================================================================
# PURPOSE : Alembic environment configuration. Connects migrations to the
#           application's Settings and SQLAlchemy Base metadata.
...
def run_migrations_offline() -> None:
    url = get_settings().database.sync_url
